...
const LUAU_VERSION = std.SemanticVersion{ .major = 0, .minor = 642, .patch = 0 };
const VERSION_HASH = "12209cf9071eb6a4c2e670f15d2236e4f4e77ea56d4f7b0b4a31ac7fefa439f7e7e7";
